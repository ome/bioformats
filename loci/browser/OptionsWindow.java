...
public class OptionsWindow extends JPanel implements ActionListener {
  ...
  public OptionsWindow(int z, int t) {
    ...
    tabbedPane.addTab("Channels", null, panel2, "Channel options");
    add(tabbedPane);
  }
  ...
  public boolean isCustomVirtualization() { return customVirtual; }

  public int[] getVirtualBounds() { return new int[] {z1, z2, t1, t2}; }
