...
public class FilePattern {
 ...
 private static boolean multichannel = false;
     
    // YTW
    /** added to avoid symbolic link problem */
 ...
 public FilePattern(File file, String directory) { 
  ...
  // YTW
  /** Gets multichannel attribute. */
  public boolean getMultichannel() { return multichannel;  }
