...
public class FormatFilter extends javax.swing.filechooser.FileFilter
  implements Comparable, java.io.FileFilter
{

  /** Associated format reader. */
  ...
  /** Compares two FormatFilter objects alphanumerically. */
  public int compareTo(Object o) {
    if (!(o instanceof FormatFilter)) return 0;
    return desc.compareTo(((FormatFilter) o).desc);
  }
