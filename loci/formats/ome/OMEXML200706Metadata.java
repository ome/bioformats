...
public class OMEXML200706Metadata extends OMEXMLMetadata {
  ...
  // -- OMEXML200706Metadata API methods --
  ...
  public ROINode getROI(int imageIndex, int roiIndex, boolean create) {
    int ndx, count;
    List list;
    // get OME node
    OMENode ome = (OMENode) root;
  ...
  public LightSourceRefNode getLightSourceRef(int imageIndex, int logicalChannelIndex, boolean create) {
    int ndx, count;
    List list;
    // get OME node
    OMENode ome = (OMENode) root;
  ...
  public DetectorRefNode getDetectorRef(int imageIndex, int logicalChannelIndex, boolean create) {
    int ndx, count;
    List list;
    // get OME node
    OMENode ome = (OMENode) root;
  ...
  // Image+/Pixels+/Plane+
  public PlaneNode getPlane(int imageIndex, int pixelsIndex, int planeIndex, boolean create) {
    int ndx, count;
    List list;
    // get OME node
    OMENode ome = (OMENode) root;
  ...
  public PlaneTimingNode getPlaneTiming(int imageIndex, int pixelsIndex, int planeIndex, boolean create) {
    int ndx, count;
    List list;
    // get OME node
    OMENode ome = (OMENode) root;
  ...
  public StagePositionNode getStagePosition(int imageIndex, int pixelsIndex, int planeIndex, boolean create) {
    int ndx, count;
    List list;
    // get OME node
    OMENode ome = (OMENode) root;
  ...
  public Integer getDisplayROIX0(int imageIndex, int roiIndex) {
    ROINode roi = getROI(imageIndex, roiIndex, false);
  ...
  public Float getLightSourceSettingsAttenuation(int imageIndex, int logicalChannelIndex) {
    LightSourceRefNode lightSourceRef = getLightSourceRef(imageIndex, logicalChannelIndex, false);
  ...
  public Float getDetectorSettingsOffset(int imageIndex, int logicalChannelIndex) {
    DetectorRefNode detectorRef = getDetectorRef(imageIndex, logicalChannelIndex, false);
  ...
  public Integer getPlaneTheZ(int imageIndex, int pixelsIndex, int planeIndex) {
    PlaneNode plane = getPlane(imageIndex, pixelsIndex, planeIndex, false);
  ...
  public Float getPlaneTimingDeltaT(int imageIndex, int pixelsIndex, int planeIndex) {
    PlaneTimingNode planeTiming = getPlaneTiming(imageIndex, pixelsIndex, planeIndex, false);
  ...
  public Float getStagePositionPositionX(int imageIndex, int pixelsIndex, int planeIndex) {
    StagePositionNode stagePosition = getStagePosition(imageIndex, pixelsIndex, planeIndex, false);
  ...
  public void setDisplayROIX0(Integer x0, int imageIndex, int roiIndex) {
    if (x0 == null) return;
    ROINode roi = getROI(imageIndex, roiIndex, true);
    roi.setX0(x0);
  }
  ...
  public void setLightSourceSettingsAttenuation(Float attenuation, int imageIndex, int logicalChannelIndex) {
    ...
    LightSourceRefNode lightSourceRef = getLightSourceRef(imageIndex, logicalChannelIndex, true);
  ...
  public void setDetectorSettingsOffset(Float offset, int imageIndex, int logicalChannelIndex) {
    ...
    DetectorRefNode detectorRef = getDetectorRef(imageIndex, logicalChannelIndex, true);
  ...
  public void setPlaneTheZ(Integer theZ, int imageIndex, int pixelsIndex, int planeIndex) {
    if (theZ == null) return;
    PlaneNode plane = getPlane(imageIndex, pixelsIndex, planeIndex, true);
    plane.setTheZ(theZ);
  }
  ...
  public void setPlaneTimingDeltaT(Float deltaT, int imageIndex, int pixelsIndex, int planeIndex) {
    ...
    PlaneTimingNode planeTiming = getPlaneTiming(imageIndex, pixelsIndex, planeIndex, true);
  ...
  public void setStagePositionPositionX(Float positionX, int imageIndex, int pixelsIndex, int planeIndex) {
    ...
    StagePositionNode stagePosition = getStagePosition(imageIndex, pixelsIndex, planeIndex, true);
