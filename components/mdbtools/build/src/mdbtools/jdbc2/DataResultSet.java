...
public class DataResultSet implements ResultSet
{
  ...
  DataResultSet(Data data,String[] names,java.sql.ResultSetMetaData metaData)
  {
    this.data = data;
  ...
  DataResultSet(Data data,String[] names,java.sql.ResultSetMetaData metaData, int maxRows)
  {
    this.data = data;
    this.metaData = metaData;
  ...
  {
    nextWasCalled = true;
    if (maxRows != 0 && currentRowNum == maxRows)
      return false;
    boolean result = data.next();
    if (result == true)
      currentRowNum++;
    return result;
  }
  ...
  public void close()
    throws SQLException
  {
    /** @todo make this resultset no longer usable after a close */
  }
  ...
  public String getString(int columnIndex)
      throws SQLException
  {
    String s = (String)data.get(columnIndex-1);
//    System.out.println("getting index: " + columnIndex + " = " + s);
    return s;
  }
  ...
  public int getInt(int columnIndex)
    throws SQLException
  {
    Integer i = (Integer)data.get(columnIndex-1);
    return i.intValue();
  }
  ...
  {
    if (metaData == null)
      throw new SQLException("no metadata to hand back");
    return metaData;
//    throw new java.lang.UnsupportedOperationException(
//        "Method DataResultSet.getMetaData() not yet implemented.");
  }
  ...
  public Object getObject(String columnName) throws SQLException {
    /**@todo Implement this java.sql.ResultSet method*/
    throw new java.lang.UnsupportedOperationException(
        "Method getObject(String) not yet implemented.");
  }
  ...
  public void updateNClob(String columnt, NClob nclob) {
    throw new RuntimeException("not implemented");
  }
  ...
  public void updateNString(String column, String s) {
    throw new RuntimeException("not implemented");
  }
