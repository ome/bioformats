...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="newOMENS">http://www.openmicroscopy.org/Schemas/OME/2013-10-dev-2</xsl:variable>
	<xsl:variable name="newSPWNS">http://www.openmicroscopy.org/Schemas/SPW/2013-10-dev-2</xsl:variable>
	<xsl:variable name="newBINNS"
		>http://www.openmicroscopy.org/Schemas/BinaryFile/2013-10-dev-2</xsl:variable>
	<xsl:variable name="newROINS">http://www.openmicroscopy.org/Schemas/ROI/2013-10-dev-2</xsl:variable>
	<xsl:variable name="newSANS">http://www.openmicroscopy.org/Schemas/SA/2013-10-dev-2</xsl:variable>
	...
	<xsl:template match="OME:OME">
		<OME xmlns="http://www.openmicroscopy.org/Schemas/OME/2013-10-dev-2"
			...
			xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
			xsi:schemaLocation="http://www.openmicroscopy.org/Schemas/OME/2013-10-dev-2
			http://www.openmicroscopy.org/Schemas/OME/2013-10-dev-2/ome.xsd">
			<xsl:apply-templates/>
		</OME>
	</xsl:template>
