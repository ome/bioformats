...
/**
 * Encoder factory implementation for ICO
 * @author  Luke Gorrie
 * @version $Revision: 1.1 $ $Date: 1999/04/07 19:29:10 $
 */
public class ICOEncoderFactory extends JimiEncoderFactorySupport
{
	public static final String[] MIME_TYPES = { "image/ico" };
	public static final String[] FILENAME_EXTENSIONS = { "ico" };

	public static final String FORMAT_NAME = "Windows Icon (ICO)";
