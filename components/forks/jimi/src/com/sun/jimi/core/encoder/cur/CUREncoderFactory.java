...
/**
 * Encoder factory implementation for CUR
 * @author  Luke Gorrie
 * @version $Revision: 1.1 $ $Date: 1999/01/20 11:28:41 $
 */
public class CUREncoderFactory extends JimiEncoderFactorySupport
{
	public static final String[] MIME_TYPES = { "image/cur" };
	public static final String[] FILENAME_EXTENSIONS = { "cur" };
