...
public final class _IFormatWriterDelD extends Ice._ObjectDelD implements _IFormatWriterDel
{
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    __result.value = __servant.canDoStacks(__current);
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    __result.value = __servant.getCompressionTypes(__current);
                    return Ice.DispatchStatus.DispatchOK;
                }
            };
            try
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    __result.value = __servant.getFramesPerSecond(__current);
                    return Ice.DispatchStatus.DispatchOK;
                }
            };
            try
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    __result.value = __servant.getMetadataRetrieve(__current);
                    return Ice.DispatchStatus.DispatchOK;
                }
            };
            try
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    __result.value = __servant.getPixelTypes(__current);
                    return Ice.DispatchStatus.DispatchOK;
                }
            };
            try
    ...
    public boolean
    isSupportedType(final int type, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    __result.value = __servant.isSupportedType(type, __current);
                    return Ice.DispatchStatus.DispatchOK;
                }
            };
            try
    ...
    public boolean
    isThisType(final String name, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                public Ice.DispatchStatus run(Ice.Object __obj)
                {
                    ...
                    __result.value = __servant.isThisType(name, __current);
                    return Ice.DispatchStatus.DispatchOK;
                }
            };
            try
    ...
    public void
    saveBytes1(final byte[] bytes, final boolean last, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
    ...
    public void
    saveBytes2(final byte[] bytes, final int series, final boolean lastInSeries, final boolean last, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
    ...
    public void
    setCompression(final String compress, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
    ...
    public void
    setFramesPerSecond(final int rate, java.util.Map<String, String> __ctx)
        throws IceInternal.LocalExceptionWrapper
    {
        final Ice.Current __current = new Ice.Current();
