...
public class PointNode extends BasicSvgShapeNode
{
	...
	/** Constructs a Point node with an associated DOM element. */
	...
	/**
	 * Constructs a Point node with an associated DOM element beneath
	 * a given parent.
	 */
	public PointNode(OMEXMLNode parent)
	{
		this(parent, true);
	}
	 ...
	 * a given parent.
	 */
	public PointNode(OMEXMLNode parent, boolean attach)
	{
