...
public class OMENode extends OMEXMLNode
{
	...
	// Element which is not complex (has only a text node)
	public String getStructuredAnnotations()
	{
		return getStringCData("StructuredAnnotations");
	}

	public void setStructuredAnnotations(String structuredAnnotations)
	{
		setCData("StructuredAnnotations", structuredAnnotations);
	}
