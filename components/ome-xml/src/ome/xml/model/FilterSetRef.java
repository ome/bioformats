...
{
	// Base: Reference -- Name: FilterSetRef -- Type: FilterSetRef -- javaBase: Reference -- javaType: Object
	...
	private static final Logger LOGGER =
		LoggerFactory.getLogger(FilterSetRef.class);
	...
	// -- Custom content from FilterSetRef specific template --
	    ...
	    throws EnumerationException
	{
		...
		{
			LOGGER.debug("Expecting node name of FilterSetRef got {}", tagName);
		}
