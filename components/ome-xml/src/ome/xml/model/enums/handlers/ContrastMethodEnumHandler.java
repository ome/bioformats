/*
 * ome.xml.model.enums.handlers.ContrastMethodHandler
 *
 *-----------------------------------------------------------------------------
 *
 ...
 * Created by melissa via xsd-fu on 2012-01-05 15:21:40-0500
 *
 *-----------------------------------------------------------------------------
 */
 ...
 * <dd><a href="http://trac.openmicroscopy.org.uk/ome/browser/bioformats.git/components/bio-formats/src/loci/formats/enums/handler/ContrastMethodHandler.java">Trac</a>,
 * <a href="http://git.openmicroscopy.org/?p=bioformats.git;a=blob;f=components/bio-formats/src/loci/formats/enums/handler/ContrastMethodHandler.java;hb=HEAD">Gitweb</a></dd></dl>
 */
public class ContrastMethodEnumHandler implements IEnumerationHandler {
  ...
  private static final Logger LOGGER =
    LoggerFactory.getLogger(ContrastMethodEnumHandler.class);
