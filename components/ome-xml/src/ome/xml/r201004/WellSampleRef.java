...
public class WellSampleRef extends Reference
{
	...
	public Element asXMLElement(Document document)
	{
		...
		Element WellSampleRef_element = document.createElement("WellSampleRef");
		if (id != null)
		{
			// Attribute property ID
			WellSampleRef_element.setAttribute("ID", id.toString());
		}
		return WellSampleRef_element;
	}

	public static WellSampleRef fromXMLElement(Element element)
		throws EnumerationException
	{
		...
		WellSampleRef instance = new WellSampleRef();
