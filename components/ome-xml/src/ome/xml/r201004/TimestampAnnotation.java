...
public class TimestampAnnotation extends Annotation
{
	 ...
	 */
	public TimestampAnnotation(Element element) throws EnumerationException
	{
		update(element);
	}
	...
	{	
		...
		if (!"TimestampAnnotation".equals(tagName))
		{
			System.err.println(String.format(
					"WARNING: Expecting node name of TimestampAnnotation got %s",
					tagName));
	...
	protected Element asXMLElement(Document document, Element TimestampAnnotation_element)
	{
		...
		if (TimestampAnnotation_element == null)
		{
			TimestampAnnotation_element =
					document.createElementNS("http://www.openmicroscopy.org/Schemas/SA/2010-04", "TimestampAnnotation");
		}
