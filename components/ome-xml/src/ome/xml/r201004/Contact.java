...
public class Contact extends Reference
{
	 ...
	 */
	public Contact(Element element) throws EnumerationException
	{
		update(element);
	}
	...
	{	
		...
		if (!"Contact".equals(tagName))
		{
			System.err.println(String.format(
					"WARNING: Expecting node name of Contact got %s",
					tagName));
	...
	protected Element asXMLElement(Document document, Element Contact_element)
	{
		...
		{
			Contact_element =
					document.createElementNS("http://www.openmicroscopy.org/Schemas/OME/2010-04", "Contact");
		}
