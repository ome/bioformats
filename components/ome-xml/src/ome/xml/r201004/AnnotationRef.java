...
public class AnnotationRef extends Reference
{
	...
	public Element asXMLElement(Document document)
	{
		...
		Element AnnotationRef_element = document.createElement("AnnotationRef");
		if (id != null)
		{
	...
	public static AnnotationRef fromXMLElement(Element element)
		throws EnumerationException
	{
		...
		AnnotationRef instance = new AnnotationRef();
