...
public class DatasetRef extends Reference
{
	...
	public Element asXMLElement(Document document)
	{
		...
		Element DatasetRef_element = document.createElement("DatasetRef");
		if (id != null)
		{
			// Attribute property ID
			DatasetRef_element.setAttribute("ID", id.toString());
		}
		return DatasetRef_element;
	}

	public static DatasetRef fromXMLElement(Element element)
		throws EnumerationException
	{
		...
		DatasetRef instance = new DatasetRef();
