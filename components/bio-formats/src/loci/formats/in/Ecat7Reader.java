 ...
 * <dd><a href="https://loci.wisc.edu/trac/java/browser/trunk/components/bio-formats/src/loci/formats/in/Ecat7Reader.java">Trac</a>,
 * <a href="https://loci.wisc.edu/svn/java/trunk/components/bio-formats/src/loci/formats/in/Ecat7Reader.java">SVN</a></dd></dl>
 */
public class Ecat7Reader extends FormatReader {
  ...
  protected void initFile(String id) throws FormatException, IOException {
    ...
    if (getMetadataOptions().getMetadataLevel() != MetadataLevel.MINIMUM) {
      ...
      store.setPixelsPhysicalSizeX(new Double(xPixelSize), 0);
      store.setPixelsPhysicalSizeY(new Double(yPixelSize), 0);
      store.setPixelsPhysicalSizeZ(new Double(zPixelSize), 0);
    }
  }
