      ...
      if (pixelSizes != null) {
        for (int i=0; i<pixelSizes.length; i++) {
          ...
          try {
            ...
            if (i == 0) store.setPixelsPhysicalSizeX(new PositiveFloat(d), 0);
            else if (i == 1) store.setPixelsPhysicalSizeY(new PositiveFloat(d), 0);
            else if (i == 2) store.setPixelsPhysicalSizeZ(new PositiveFloat(d), 0);
          }
