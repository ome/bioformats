 ...
 * <dd><a href="https://skyking.microscopy.wisc.edu/trac/java/browser/trunk/components/bio-formats/src/loci/formats/in/RHKReader.java">Trac</a>,
 * <a href="https://skyking.microscopy.wisc.edu/svn/java/trunk/components/bio-formats/src/loci/formats/in/RHKReader.java">SVN</a></dd></dl>
 */
public class RHKReader extends FormatReader {
  ...
  protected void initFile(String id) throws FormatException, IOException {
    ...
    if (getMetadataOptions().getMetadataLevel() == MetadataLevel.ALL) {
      store.setDimensionsPhysicalSizeX(xScale, 0, 0);
      store.setDimensionsPhysicalSizeY(yScale, 0, 0);
