...
import loci.formats.enums.IlluminationType;
...
public class IlluminationTypeEnumHandler implements IEnumerationHandler {
  ...
  private static Hashtable<String, String> makePatterns() {
    ...
    p.put("^\\s*Transmitted", "Transmitted");
    p.put("^\\s*Epifluorescence", "Epifluorescence");
    p.put("^\\s*Oblique", "Oblique");
    p.put("^\\s*NonLinear", "NonLinear");
    p.put("^\\s*Other", "Other");
    return p;
  }
