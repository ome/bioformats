 ...
 * DOMs for the 2008-09 version of OME-XML. It requires the
 * ome.xml.r200809 package to compile (part of ome-xml.jar).
 *
 ...
 */
public class OMEXML200809Metadata extends AbstractOMEXMLMetadata {

  // -- Constants --

  private static final Logger LOGGER =
    LoggerFactory.getLogger("OMEXML200809Metadata");
  ...
  public int getShapeCount(int imageIndex, int roiIndex) {
    for (int i=0; i<Integer.MAX_VALUE; i++) {
      if (getShapeNode(imageIndex, roiIndex, i, false) == null) return i;
    }
    return -1;
  }
  ...
  public String getEmFilterLotNumber(int instrumentIndex, int filterIndex) {
    // NB: LotNumber unsupported for schema version 2008-09
    return null;
  }
  ...
  public String getEmFilterManufacturer(int instrumentIndex, int filterIndex) {
    // NB: Manufacturer unsupported for schema version 2008-09
    return null;
  }
  ...
  public String getEmFilterModel(int instrumentIndex, int filterIndex) {
    // NB: Model unsupported for schema version 2008-09
    return null;
  }
  ...
  public String getEmFilterType(int instrumentIndex, int filterIndex) {
    // NB: Type unsupported for schema version 2008-09
    return null;
  }
  ...
  public Boolean getMaskPixelsBigEndian(int imageIndex, int roiIndex, int shapeIndex) {
    MaskPixelsNode maskPixels = getMaskPixelsNode(imageIndex, roiIndex, shapeIndex, false);
          return maskPixels == null ? null : maskPixels.getBigEndian();
      }
  ...
  public byte[] getMaskPixelsBinData(int imageIndex, int roiIndex, int shapeIndex) {
    MaskPixelsNode maskPixels = getMaskPixelsNode(imageIndex, roiIndex, shapeIndex, false);
      ...
      String binData = maskPixels.getBinData();
      try {
  ...
  public String getMaskPixelsExtendedPixelType(int imageIndex, int roiIndex, int shapeIndex) {
    MaskPixelsNode maskPixels = getMaskPixelsNode(imageIndex, roiIndex, shapeIndex, false);
          return maskPixels == null ? null : maskPixels.getExtendedPixelType();
      }
  ...
  public String getMaskPixelsID(int imageIndex, int roiIndex, int shapeIndex) {
    MaskPixelsNode maskPixels = getMaskPixelsNode(imageIndex, roiIndex, shapeIndex, false);
          return maskPixels == null ? null : maskPixels.getNodeID();
      }
  ...
  public Integer getMaskPixelsSizeX(int imageIndex, int roiIndex, int shapeIndex) {
    MaskPixelsNode maskPixels = getMaskPixelsNode(imageIndex, roiIndex, shapeIndex, false);
          return maskPixels == null ? null : maskPixels.getSizeX();
      }
  ...
  public Integer getMaskPixelsSizeY(int imageIndex, int roiIndex, int shapeIndex) {
    MaskPixelsNode maskPixels = getMaskPixelsNode(imageIndex, roiIndex, shapeIndex, false);
          return maskPixels == null ? null : maskPixels.getSizeY();
      }
  ...
  public Boolean getObjectiveIris(int instrumentIndex, int objectiveIndex) {
    // NB: Iris unsupported for schema version 2008-09
    return null;
  }
  ...
  public String getPlateColumnNamingConvention(int plateIndex) {
    // NB: ColumnNamingConvention unsupported for schema version 2008-09
    return null;
  }
  ...
  public String getPlateRowNamingConvention(int plateIndex) {
    // NB: RowNamingConvention unsupported for schema version 2008-09
    return null;
  }
  ...
  public Integer getPlateRefSample(int screenIndex, int plateRefIndex) {
    // NB: Sample unsupported for schema version 2008-09
    return null;
  }
  ...
  public String getPlateRefWell(int screenIndex, int plateRefIndex) {
    // NB: Well unsupported for schema version 2008-09
    return null;
  }
  ...
  public String getScreenExtern(int screenIndex) {
    // NB: Extern unsupported for schema version 2008-09
    return null;
  }
  ...
  public void createRoot() {
    try {
      setRoot(ome.xml.OMEXMLFactory.newOMENode("2008-09"));
    }
  ...
  public void setArcType(String type, int instrumentIndex, int lightSourceIndex) {
    ...
    ArcNode arcNode = getArcNode(instrumentIndex, lightSourceIndex, true);
            String[] enumeration = new String[] {"Hg", "Xe", "HgXe", "Unknown"};
  ...
  /* @see loci.formats.meta.MetadataStore#setDetectorAmplificationGain(Double, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setDetectorGain(Double, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setDetectorOffset(Double, int, int) */
  ...
  public void setDetectorType(String type, int instrumentIndex, int detectorIndex) {
    if (type == null) return;
    DetectorNode detectorNode = getDetectorNode(instrumentIndex, detectorIndex, true);
            String[] enumeration = new String[] {"CCD", "IntensifiedCCD", "AnalogVideo", "PMT", "Photodiode", "Spectroscopy", "LifetimeImaging", "CorrelationSpectroscopy", "FTIR", "EM-CCD", "APD", "CMOS", "Unknown"};
    if (enumeration.length > 0) {
      for (String v : enumeration) {
        if (v.equalsIgnoreCase(type)) {
          type = v;
          ...
          return;
              ...
              detectorNode.setType("Unknown");
          }
    else
          detectorNode.setType(type);
      }

  /* @see loci.formats.meta.MetadataStore#setDetectorVoltage(Double, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setDetectorZoom(Double, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setDetectorSettingsGain(Double, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setDetectorSettingsOffset(Double, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setDetectorSettingsReadOutRate(Double, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setDetectorSettingsVoltage(Double, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setDimensionsPhysicalSizeX(Double, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setDimensionsPhysicalSizeY(Double, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setDimensionsPhysicalSizeZ(Double, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setDimensionsTimeIncrement(Double, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setDisplayOptionsZoom(Double, int) */
  ...
  public void setFilamentType(String type, int instrumentIndex, int lightSourceIndex) {
    ...
    FilamentNode filamentNode = getFilamentNode(instrumentIndex, lightSourceIndex, true);
            String[] enumeration = new String[] {"Incandescent", "Halogen", "Unknown"};
    if (enumeration.length > 0) {
      for (String v : enumeration) {
        if (v.equalsIgnoreCase(type)) {
          type = v;
  ...
  /* @see loci.formats.meta.MetadataStore#setImagingEnvironmentAirPressure(Double, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setImagingEnvironmentCO2Percent(Double, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setImagingEnvironmentHumidity(Double, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setImagingEnvironmentTemperature(Double, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setLaserRepetitionRate(Double, int, int) */
  ...
  public void setLaserType(String type, int instrumentIndex, int lightSourceIndex) {
    if (type == null) return;
    LaserNode laserNode = getLaserNode(instrumentIndex, lightSourceIndex, true);
            String[] enumeration = new String[] {"Excimer", "Gas", "MetalVapor", "SolidState", "Dye", "Semiconductor", "FreeElectron", "Unknown"};
    if (enumeration.length > 0) {
      for (String v : enumeration) {
        if (v.equalsIgnoreCase(type)) {
          type = v;
  ...
  /* @see loci.formats.meta.MetadataStore#setLightSourcePower(Double, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setLightSourceRefAttenuation(Double, int, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setLightSourceSettingsAttenuation(Double, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setLogicalChannelNdFilter(Double, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setLogicalChannelPinholeSize(Double, int, int) */
  ...
  public void setMaskPixelsBigEndian(Boolean bigEndian, int imageIndex, int roiIndex, int shapeIndex) {
    ...
    MaskPixelsNode maskPixelsNode = getMaskPixelsNode(imageIndex, roiIndex, shapeIndex, true);
              maskPixelsNode.setBigEndian(bigEndian);
      }
  ...
  public void setMaskPixelsBinData(byte[] binData, int imageIndex, int roiIndex, int shapeIndex) {
    ...
    MaskPixelsNode maskPixelsNode = getMaskPixelsNode(imageIndex, roiIndex, shapeIndex, true);
      ...
      String data = null;
      try {
        data = new String(codec.compress(binData, null));
      }
      catch (FormatException e) { }
      maskPixelsNode.setBinData(data);
      }
  ...
  public void setMaskPixelsExtendedPixelType(String extendedPixelType, int imageIndex, int roiIndex, int shapeIndex) {
    if (extendedPixelType == null) return;
    MaskPixelsNode maskPixelsNode = getMaskPixelsNode(imageIndex, roiIndex, shapeIndex, true);
            String[] enumeration = new String[] {"bit", "double", "complex", "double-complex"};
    if (enumeration.length > 0) {
      for (String v : enumeration) {
        if (v.equalsIgnoreCase(extendedPixelType)) {
          extendedPixelType = v;
          maskPixelsNode.setExtendedPixelType(extendedPixelType);
          return;
        }
      }
          }
  ...
  public void setMicroscopeType(String type, int instrumentIndex) {
    if (type == null) return;
    MicroscopeNode microscopeNode = getMicroscopeNode(instrumentIndex, true);
            String[] enumeration = new String[] {"Upright", "Inverted", "Dissection", "Electrophysiology", "Unknown"};
    if (enumeration.length > 0) {
      for (String v : enumeration) {
        if (v.equalsIgnoreCase(type)) {
          type = v;
          ...
          return;
              ...
              microscopeNode.setType("Unknown");
          }
    else
          microscopeNode.setType(type);
      }
  ...
  /* @see loci.formats.meta.MetadataStore#setObjectiveCalibratedMagnification(Double, int, int) */
  ...
  public void setObjectiveCorrection(String correction, int instrumentIndex, int objectiveIndex) {
    ...
    ObjectiveNode objectiveNode = getObjectiveNode(instrumentIndex, objectiveIndex, true);
            String[] enumeration = new String[] {"UV", "PlanApo", "PlanFluor", "SuperFluor", "VioletCorrected", "Unknown"};
    if (enumeration.length > 0) {
      for (String v : enumeration) {
        if (v.equalsIgnoreCase(correction)) {
          ...
          return;
              ...
              objectiveNode.setCorrection("Unknown");
          }
    else
          objectiveNode.setCorrection(correction);
      }
  ...
  public void setObjectiveImmersion(String immersion, int instrumentIndex, int objectiveIndex) {
    ...
    ObjectiveNode objectiveNode = getObjectiveNode(instrumentIndex, objectiveIndex, true);
            String[] enumeration = new String[] {"Oil", "Water", "WaterDipping", "Air", "Multi", "Glycerol", "Other", "Unknown"};
    if (enumeration.length > 0) {
      for (String v : enumeration) {
  ...
  /* @see loci.formats.meta.MetadataStore#setObjectiveLensNA(Double, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setObjectiveWorkingDistance(Double, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setObjectiveSettingsCorrectionCollar(Double, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setObjectiveSettingsRefractiveIndex(Double, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setPlaneTimingDeltaT(Double, int, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setPlaneTimingExposureTime(Double, int, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setShapeStrokeOpacity(Double, int, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setStageLabelX(Double, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setStageLabelY(Double, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setStageLabelZ(Double, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setStagePositionPositionX(Double, int, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setStagePositionPositionY(Double, int, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setStagePositionPositionZ(Double, int, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setWellSamplePosX(Double, int, int, int) */
  ...
  /* @see loci.formats.meta.MetadataStore#setWellSamplePosY(Double, int, int, int) */
