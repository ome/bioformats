 ...
 * <dd><a href="https://skyking.microscopy.wisc.edu/trac/java/browser/trunk/components/bio-formats/test/loci/formats/utests/tiff/TiffPixelsTest.java">Trac</a>,
 * <a href="https://skyking.microscopy.wisc.edu/svn/java/trunk/components/bio-formats/test/loci/formats/utests/tiff/TiffPixelsTest.java">SVN</a></dd></dl>
 */
public class TiffPixelsTest {
  ...
  private byte[] readSavedPlane() throws FormatException, IOException {
    ...
    saver.writeImage(data, ifd, false, FormatTools.UINT16);
    out.close();
